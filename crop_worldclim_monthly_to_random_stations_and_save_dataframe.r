...
wc2rnd <- wc2 %>% filter(WCID == "33111" | WCID =="55020" | WCID =="48521"| WCID =="17110"| WCID =="11867" |
                         WCID == "40431" | WCID =="18153" | WCID =="29650"| WCID =="54050"| WCID =="20626")
...
wc2rnd <- wc2 %>% filter(WCID %in% c("33111","55020" ,"48521","17110","11867", "40431" ,"18153" ,"29650","54050","20626"))
